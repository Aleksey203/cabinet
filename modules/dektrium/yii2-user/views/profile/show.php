    ...
    <div class="col-xs-12 col-sm-6 col-md-6">
        <div class="row">
            <div class="col-sm-6 col-md-4">
                <img src="<?=\Yii::getAlias('@web/uploads/users')?>/<?= Html::encode($profile->user_id) ?>/<?= Html::encode($profile->avatar) ?>" alt="" style="max-width: 180px;" class="img-rounded img-responsive" />
            </div>
